  ...
  <div>
    ...
    <div v-if="this.$route.query.action === 'edit'">
      ...
      <form class="box" @submit.prevent="createCurriculum">
        ...
        <div class="field" v-for="source in this.curriculumData.sources" v-bind:key="source.sourceId">
          <label class="label">Resources</label>
          <div class="control">
            <input class="input is-success" v-model="curriculumData.sources" type="text" id="curriculumName"
              name="curriculumName" required />
          </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <label class="radio">
              <input type="radio" name="answer" id="formAssignment" v-bind:value="true"
               v-if="!formOrAssignmentUpload" @click="formOrAssignmentUpload = true"/>
              Form
            </label>
            <label class="radio">
              <input type="radio" name="answer" id="uploadAssignment" v-bind:value="false"
               v-if="formOrAssignmentUpload" @click="formOrAssignmentUpload = false"/>
              Assignment Upload
            </label>
          </div>
        </div>
        <div class="assignment" v-if="formOrAssignmentUpload = true">
          <div class="field">
            <div class="control">
          ...
          <div class="field" v-for="question in this.curriculumData.questions" v-bind:key="question.questionId">
            <div class="control">
              <input class="input is-success" v-model="curriculumData.questions" name="curriculum_questions" type="text"
                placeholder="Description" id="assignmentName" required />
            </div>
          </div>
        </div>
        <div class="field" v-if="formOrAssignmentUpload = false">
          <div class="control">
  ...
  data() {
    return {
      ...
      curriculumData: {
        ...
        sources: this.content.sources || ['hi'],
        ...
        questions: this.content.questions || ['Mock Question'],
      },
    };
  },
  created() { },
